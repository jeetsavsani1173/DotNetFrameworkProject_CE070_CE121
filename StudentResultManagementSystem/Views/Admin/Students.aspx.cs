...
namespace StudentResultManagementSystem.Views.Admin
{
    public partial class Students : System.Web.UI.Page
    {
        ...
        {
            string Query = "Select StUsn as [Roll Number], StName as [Student Name], FName as [Father's Name], StDOB as [D.O.B Of Student],StAdd as Address, StPhone as Phone,StGen as Gender from StudentTbl";
