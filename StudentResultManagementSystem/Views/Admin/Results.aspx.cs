    ...
    public partial class Results : System.Web.UI.Page
    {
        ...
        protected void EditBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "update ResultTbl set Student='{0}',Algo='{1}',CProg='{2}',Java='{3}',DBMS='{4}',Python='{5}',Total='{6}',Pourcentage='{7}',Decision='{8}' where Student='{9}'";
                Query = string.Format(Query, Usn, Algo, CProg, Java, DBMS, Python,Total,Pourcentage,Decision, Usn);
                Con.SetDatas(Query);
                ShowResults();
